...
image_path = "Data Visualization.PNG"  # Replace with the path to your image
image = Image.open(image_path)

#st.image(image, use_column_width=True)# caption="Your Image Caption")
# Define the layout with two columns
col1, col2 = st.columns([2, 1], gap="small")  # Adjust the ratio as needed

# Display the image in the first column
with col1:
    st.image(image, use_column_width=True, clamp=True)  # Adjust width as needed
